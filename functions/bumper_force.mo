block bumper_force
  ...
  Modelica.Blocks.Interfaces.RealOutput y annotation(Placement(visible = true, transformation(origin = {130, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  parameter Real t1 = 0;
  parameter Real t2 = 0;
  parameter Real a1 = 0;
  parameter Real a2 = 0;
equation
  y = bumper(t1, t2, a1, a2, u);
